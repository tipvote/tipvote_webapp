...
def take_coin_from_tipper_bch_comment(sender_id, amount, commentid, recieverid):
    ...
    try:
        ...
        newbalance_sender = Decimal(curbal_sender) - Decimal(amounttomod)
...
def sendcoin_to_poster_bch_post(sender_id, amount, postid, recieverid):
...
def sendcoin_subowner_bch_post(sender_id, amount, postid, recieverid):
