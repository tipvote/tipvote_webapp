...
@people.route('/tipped', methods=['GET'])
@login_required
def people_coinposts():
    ...
    next_url = url_for('people.people_coinposts', page=posts.next_num) \
        if posts.has_next else None
    prev_url = url_for('people.people_coinposts', page=posts.prev_num) \
        if posts.has_prev else None
